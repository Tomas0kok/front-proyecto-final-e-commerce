  ...
  const products = [
    {
      ...
      detailedDescription: 'Nuestras bolsas reutilizables están fabricadas con materiales 100% reciclados y son perfectas para tus compras diarias. Resistentes, lavables y con capacidad para hasta 15kg. Contribuye al cuidado del medio ambiente mientras haces tus compras.',
      price: '$1,500',
    ...
    },
    {
      ...
      detailedDescription: 'Set de tres cestos especialmente diseñados para organizar tu cocina. Incluye cestos de diferentes tamaños para separar residuos orgánicos, reciclables y basura general. Material resistente y fácil de limpiar.',
      price: '$350',
    ...
    },
    {
      ...
      detailedDescription: 'Cesto económico ideal para interiores, perfecto para comenzar con el reciclaje en tu hogar. Diseño compacto que se adapta a cualquier espacio. Excelente relación calidad-precio.',
      price: '$280',
    ...
    },
    {
      ...
      detailedDescription: 'Combo completo para compostar que incluye compostera de alta calidad, filtros de carbón activado, herramientas y manual instructivo. Todo lo que necesitas para crear tu propio compost casero y reducir residuos orgánicos.',
      price: '$1,500',
    ...
    },
    {
      ...
      detailedDescription: 'Kit de productos reciclables que incluye contenedores separadores con etiquetas para papel, plástico, vidrio y metal. Sistema de clasificación intuitivo que facilita el reciclaje en el hogar.',
      price: '$350',
    ...
    },
    {
      ...
      detailedDescription: 'Mini compostera perfecta para apartamentos o espacios pequeños. Con filtro de carbón activado que elimina olores. Capacidad de 5 litros, ideal para residuos orgánicos diarios de 1-2 personas.',
      price: '$280',
